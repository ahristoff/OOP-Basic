namespace Forum.App
{
    ...
    internal class MenuController
    {
        ...
        {
            Username = ((IReadUserInfoController)this.CurrentController).Username;
            this.LogInUser();
        ...
        {
            foreach (var x in this.controllers)
            {
                if (x is IUserRestrictedController userRestrictedController)
                {
